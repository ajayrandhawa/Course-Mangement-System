...
?>
													...
													<div class="stat-panel-title text-uppercase">Courses</div>
												</div>
											</div>
...
?>
													...
													<div class="stat-panel-title text-uppercase">Total Ads</div>
												</div>
											</div>
...
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($bg);?></div>
													<div class="stat-panel-title text-uppercase">Subscriptions Request</div>
												</div>
											</div>
											<a href="manage-bloodgroup.php" class="block-anchor panel-footer text-center">Full Detail <i class="fa fa-arrow-right"></i></a>
										</div>
...
?>
													<div class="stat-panel-number h1 "><?php echo htmlentities($query);?></div>
													<div class="stat-panel-title text-uppercase">Team Member</div>
												</div>
											</div>
											<a href="manage-conactusquery.php" class="block-anchor panel-footer text-center">Full Detail &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
